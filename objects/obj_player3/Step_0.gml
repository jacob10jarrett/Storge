...
if (inCutscene) {
	...
	audio_play_sound(snd_song3, 1, true);
        ...
        case 2:
            targetX = 2196; // Second target coordinates
            targetY = 696;
			shouldBlink = true;
			image_xscale = -4;
            moveTowardsPoint(targetX, targetY, 1); // Move towards the second point
            if (cutsceneStep == 2) {
                moveTowardsPoint(targetX, targetY, 1); 
            }
            break;
